...
const WHY_CHOOSE_VALUES = [
  {
    ...
    description: "Our barbers aren't just skilled — they're trained under a mentorship-driven program that sharpens both technique and mindset. We study more than just your hair — we read your style, your rhythm, your presence. The result? Precision cuts, tailored to you, delivered by professionals dedicated to mastering their craft."
  },
  {
    number: "02",
    title: "Rooted in Tradition",
    description: "We honor the legacy of classic barbering with every blade and brushstroke. From traditional straight-razor shaves to clean fades, our work is steeped in old-school techniques while staying sharp on the trends that matter today. It's heritage, with a modern edge."
  },
  {
    number: "03",
    title: "Premium Grooming Experience",
    description: "More than a cut — this is your time. From hot towel rituals and personal consultations to top-shelf grooming products and uninterrupted service, everything is designed for your comfort. Settle into your chair — it's yours until you say otherwise."
  },
];
...
const REVIEWS: Value[] = [
  {
    ...
    description: "The best barbershop experience I've ever had. The attention to detail and the atmosphere is incredible. Highly recommend!"
  },
  {
    title: "Professional & Welcoming",
    description: "From the moment I walked in, I felt like family. The quality of work is outstanding. Will definitely be back."
  },
  {
    title: "True Craftsmanship",
    description: "These guys are true artists. My beard has never looked better, and the hot towel treatment was the perfect finishing touch."
  },
  {
    title: "Consistent Quality",
    description: "Been coming here for months and every visit is consistently excellent. The team really knows their craft and takes pride in their work."
  },
  {
    title: "Modern Gentleman's Choice",
    description: "House of Havana has become my go-to spot. The combination of traditional techniques with modern style is exactly what I was looking for."
  },
  {
    title: "Outstanding Experience",
    description: "It's not just a haircut, it's a complete grooming experience that leaves you feeling confident and refreshed."
  },
];
        ...
        <div className="container">
          ...
          <div className="mb-24">
            ...
            <p className="text-foreground/40 leading-relaxed text-center max-w-2xl mx-auto">
              We're not your average barbershop. At House of Havana, every detail matters — from the moment you walk in to the moment you walk out feeling like the best version of yourself.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            {WHY_CHOOSE_VALUES.map((value, index) => (
              <div key={index} className="border-t border-foreground/10 py-12 grid grid-cols-12 gap-8 items-start group hover:border-foreground/20 transition-colors">
                {/* Number */}
                ...
                <div className="col-span-10 md:col-span-11 pt-2">
                  <h3 className="heading-4-italic mb-4 text-foreground">{value.title}</h3>
                  <p className="text-foreground/50 leading-relaxed max-w-2xl">{value.description}</p>
                </div>
              </div>
            ))}
          </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-16">
           ...
           <div className='md:col-span-6 md:col-start-7 flex items-end'>
             <p className="text-foreground/50 leading-relaxed">
               Don't just take our word for it. Here's what our valued clients have to say about their House of Havana experience.
             </p>
           </div>
         </div>
